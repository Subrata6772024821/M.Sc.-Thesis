...
# ======================================
# BOUNDARY-SNAPSHOT SPEED FUNCTION (plain/unweighted -- unchanged from
# your snapshot script)
#
# For an interval [t0, t1), this takes exactly two snapshots -- one at t0
# and one at t1 -- averages every vehicle's instantaneous speed found at
# EACH of those two instants separately, and then takes the PLAIN
# (unweighted) average of those two snapshot averages as the final speed
