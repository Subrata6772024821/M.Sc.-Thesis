"""
With-DTW Combined Density Calibration -- 3 methods x 3 proxy pairs
=====================================================================

Reads the one-to-one windowed-DTW alignment results (one sheet per
proxy: Acc-Flow_SMS, Acc-Flow_Snapshot, Acc-Occupancy -- each already
a clean 61-row, exactly-one-to-one table with columns
Reference_Value / Aligned_Proxy_Value) and builds a combined output
workbook with 9 sheets:
...
OUTPUT_PATH = os.path.join(_parent_dir, f"{_run_id}_AllMethods_With DTW_30sec.xlsx")
