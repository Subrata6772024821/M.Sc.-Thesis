...
Reads all 9 sheets of *_Combined_Density_30sec_AllMethods.xlsx and produces two
grouped bar charts (one for MAD, one for MPD), each comparing:
    Before Calibration | Mean Multiplier | 2nd Degree Poly | GPR
across the three density proxies: Flow
_SMS, Flow_Snapshot, Occupancy.
...
# ----------------------------------------------------------------------
FILE_PATH = r"D:\Thesis_Final Data Analysis\05_12_25_1315_1345\120_sec\05_12_25_1315_1345_Combined Density_120sec_AllMethods.xlsx"

# Images are saved to the PARENT of the 60_sec folder (i.e. the session folder)
OUTPUT_DIR = os.path.dirname(r"D:\Thesis_Final Data Analysis\05_12_25_1315_1345\120_sec")

# Session date/time/aggregation, shown above each chart
SESSION_DATE = "05 December, 2025"
SESSION_TIME = "13:15 to 13:45"
AGGREGATION_LABEL = "120 sec Aggregation"   # e.g. "30 sec Aggregation" / "60 sec Aggregation" / "2 min Aggregation"
...
def main():
    ...
    plot_metric(
        ...
        save_path=os.path.join(OUTPUT_DIR, f"MAD_comparison_{OUTPUT_SUFFIX}.png"),
    )
    ...
    plot_metric(
        ...
        metric_key="MPD",
        metric_label="MPD (%)",
        save_path=os.path.join(OUTPUT_DIR, f"MPD_comparison_{OUTPUT_SUFFIX}.png"),
    )
